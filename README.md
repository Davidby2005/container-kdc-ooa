...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-kdc-ooa.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-kdc-ooa.containers.anotherwebservice.com/
...
```
git clone git@github.com:Davidby2005/container-kdc-ooa.git
cd container-kdc-ooa
```
...
```
docker attach container-kdc-ooa
```
